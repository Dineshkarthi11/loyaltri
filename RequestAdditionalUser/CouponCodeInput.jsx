...
function CouponCodeInput() {
  ...
  const handleApplyClick = () => {
    ...
    navigate("/request-additional-user-more");
  };

  return (
    <div className="flex flex-col mt-3.5 w-full text-sm leading-none min-h-[53px]">
      <div className="flex overflow-hidden gap-10 justify-between items-center px-2 py-2.5 w-full rounded-lg border border-gray-300 border-dashed bg-zinc-50 min-h-[53px]">
        <div className="flex gap-2 items-center self-stretch my-auto text-gray-500">
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/d8007e64ed713fef7bca1475766268dafc9bb68562b78e266a1af4a2ba01f188?placeholderIfAbsent=true&apiKey=740fe41628444c68b4015f1a2abbfb39" className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square" alt="" />
          <input
            type="text"
        ...
        <button
          onClick={handleApplyClick} // Trigger navigation on click
