        ...
        <div className="flex gap-4 font-medium">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={toggleExpand}>
              <img
                src={isExpanded ? "https://github.com/Dineshkarthi11/loyaltri/blob/main/assets/up.png?raw=true" : "https://github.com/Dineshkarthi11/loyaltri/blob/main/assets/down.png?raw=true"} // Replace with actual arrow icons
                alt="Toggle"
                className="w-8"
              />
            </button>
